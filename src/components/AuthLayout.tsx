  ...
  if (isLoading) {
    return (
      <div className="relative">
        <AuthLayoutSkeleton />
        {slowLoad && (
          <div className="absolute inset-x-0 top-6 mx-auto w-fit max-w-sm rounded-md border bg-background px-4 py-2 text-center text-sm shadow-md">
            Taking longer than expected — the server may be waking up. If this
            message persists, try reloading the page.
          </div>
        )}
      </div>
    );
